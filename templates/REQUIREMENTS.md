...
<!-- One paragraph: the problem being solved and for whom. Why does this application deserve to exist? -->

## 2. Target users

<!-- Who uses it, in what context, how often. One line per user type. -->

## 3. Success criteria

<!-- How we know the product works: measurable or observable outcomes, not features. -->
...
<!-- Only ones that actually constrain design: performance targets, auth needs, data retention, accessibility. -->

## 6. Out of scope

<!-- Explicit non-goals. As valuable as the requirements — protects the backlog from drift. -->
